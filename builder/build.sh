...
cp "$ROOT/runtime/gateway.mjs" "$PACKAGE/gateway.mjs"
cp "$ROOT/runtime/start.mjs" "$PACKAGE/start.mjs"
cp "$ROOT/runtime/start.sh" "$PACKAGE/start.sh"
cp "$ROOT/runtime/.env.example" "$PACKAGE/.env.example"
cp "$ROOT/runtime/README-FIRST.md" "$PACKAGE/README-FIRST.md"
cp "$ROOT/runtime/THIRD_PARTY_NOTICES.md" "$PACKAGE/THIRD_PARTY_NOTICES.md"
